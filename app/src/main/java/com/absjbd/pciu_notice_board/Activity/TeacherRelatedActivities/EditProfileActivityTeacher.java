...
import com.absjbd.pciu_notice_board.Activity.EditProfileActivity;
...
public class EditProfileActivityTeacher extends AppCompatActivity {
...
//        getWindow().addFlags(WindowManager.LayoutParams.FLAG_KEEP_SCREEN_ON);
    ...
    private void initViews() {
        ...
        editName = (BootstrapEditText) findViewById(R.id.teacher_editStudentNameET);
        editAddress = (BootstrapEditText) findViewById(R.id.teacher_editStudentAddressET);
        editPhone = (BootstrapEditText) findViewById(R.id.teacher_editStudentPhoneET);
        editEmail = (BootstrapEditText) findViewById(R.id.teacher_editStudentEmailET);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_homeBack) {
            Intent intent = new Intent(EditProfileActivityTeacher.this, MainActivityTeacher.class);
    ...
    public void onClickUpdateProfileBtnT(View view) {
    ...
    private void editProfileProcess(final String studentName, final String studentAddress, final String studentPhone, final String studentEmail) {
        ...
        Call<ServerResponse> call = apiInterface.updateProfile(
                Config_Ref.EDIT_PROFILE_OPERATION_TEACHER,
       ...
       /* student.setStudentName(studentName);
        ...
        call.enqueue(new Callback<ServerResponse>() {
            ...
            public void onResponse(Call<ServerResponse> call, Response<ServerResponse> response) {
                ...
                pDialog.dismiss();
                if (resp != null) {
                    new SweetAlertDialog(EditProfileActivityTeacher.this, SweetAlertDialog.SUCCESS_TYPE)
                    ...
                    Toast.makeText(EditProfileActivityTeacher.this, "success, Message: " + resp.getMessage() + ", result: " + resp.getResult(), Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(EditProfileActivityTeacher.this, "Null response from server, Message: " + resp.getMessage() + ", result: " + resp.getResult(), Toast.LENGTH_SHORT).show();
                }
            ...
            public void onFailure(Call<ServerResponse> call, Throwable t) {
                pDialog.dismiss();
                new SweetAlertDialog(EditProfileActivityTeacher.this, SweetAlertDialog.ERROR_TYPE)
                        .setTitleText("Failed!")
                        .setContentText("Unable to update your profile.")
                        .show();
                Toast.makeText(EditProfileActivityTeacher.this, "Localized: " + t.getLocalizedMessage() + "\n Message: " + t.getMessage() + "\nstackTrace: " + t.getStackTrace(), Toast.LENGTH_SHORT).show();
            ...
            private void updateSharedPreference() {
                ...
                studentJson = gson.toJson(student);
                editor.putString("teacherObject", studentJson); //storing student as string
                editor.apply();
