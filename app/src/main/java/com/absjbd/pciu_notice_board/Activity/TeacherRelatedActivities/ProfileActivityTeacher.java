...
public class ProfileActivityTeacher extends AppCompatActivity {
...
//        getWindow().addFlags(WindowManager.LayoutParams.FLAG_KEEP_SCREEN_ON);
    ...
    private void initViews() {
        studentNameLbl = (BootstrapLabel) findViewById(R.id.teacher_profile_name);
        studentAddressLbl = (BootstrapLabel) findViewById(R.id.teacher_profile_address);
        studentPhoneLbl = (BootstrapLabel) findViewById(R.id.teacher_profile_phone);
        studentEmailLbl = (BootstrapLabel) findViewById(R.id.teacher_profile_email);
        studentDepartmentLbl = (BootstrapLabel) findViewById(R.id.teacher_profile_department);
        studentBatchLbl = (BootstrapLabel) findViewById(R.id.teacher_profile_batchId);
        studentIdLbl = (BootstrapLabel) findViewById(R.id.teacher_profile_studentId);
        studentUniqueIdLbl = (BootstrapLabel) findViewById(R.id.teacher_profile_uniqueId);
        studentDateTimeLbl = (BootstrapLabel) findViewById(R.id.teacher_profile_dateTime);
        studentStatusLbl = (BootstrapLabel) findViewById(R.id.teacher_profile_status);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_homeBack) {
            Intent intent = new Intent(ProfileActivityTeacher.this, MainActivityTeacher.class);
    ...
    public void OnClickEditProfileBtnT(View view) {
        Intent intent = new Intent(ProfileActivityTeacher.this, EditProfileActivityTeacher.class);
        startActivity(intent);
