...
import com.absjbd.pciu_notice_board.Activity.Forgot_Password;
...
public class Forgot_Password_Teacher extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_forgot__password__teacher);
    ...
    private void initViews() {
        ...
        btn_reset = (BootstrapButton) findViewById(R.id.btn_reset_t);
        tv_timer = (TextView) findViewById(R.id.timer_t);
        et_code = (BootstrapEditText) findViewById(R.id.et_code_t);
        et_email = (BootstrapEditText) findViewById(R.id.et_email_t);
        et_password = (BootstrapEditText) findViewById(R.id.et_password_t);
        et_password.setVisibility(View.GONE);
        et_code.setVisibility(View.GONE);
        tv_timer.setVisibility(View.GONE);
        btn_reset.setOnClickListener(this);
        progress = (ProgressBar) findViewById(R.id.progress_t);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_homeBack) {
            Intent intent = new Intent(Forgot_Password_Teacher.this, LoginActivity.class);
    ...
    private void startCountdownTimer() {
        countDownTimer = new CountDownTimer(300000, 1000) {
            ...
            public void onFinish() {
                Toast.makeText(Forgot_Password_Teacher.this, "Time Out ! Request again to reset password.", Toast.LENGTH_LONG).show();
                goToLogin();
            }
        }.start();
    }
    ...
    private void finishResetPasswordProcess(String email, String code, String password) {
        ...
        Call<ServerResponse> call = apiInterface.changePassword(
                Config_Ref.RESET_PASSWORD_FINISH_t, //TODO: login operation for teacher
                email,
                code,
                password
        );
        ...
        call.enqueue(new Callback<ServerResponse>() {
            ...
            public void onResponse(Call<ServerResponse> call, Response<ServerResponse> response) {
                ...
                Toast.makeText(Forgot_Password_Teacher.this, resp.getMessage(), Toast.LENGTH_LONG).show();
            ...
            public void onFailure(Call<ServerResponse> call, Throwable t) {
                ...
                Toast.makeText(Forgot_Password_Teacher.this, t.getLocalizedMessage(), Toast.LENGTH_SHORT).show();
    ...
    private void initiateResetPasswordProcess(String email) {
        ...
        Call<ServerResponse> call = apiInterface.forgotPassword(
                Config_Ref.RESET_PASSWORD_INITIATE_t, //TODO: login operation for teacher
                email
        );
        call.enqueue(new Callback<ServerResponse>() {
            @Override
