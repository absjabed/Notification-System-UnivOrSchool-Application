...
import com.absjbd.pciu_notice_board.AdapterPackage.ToDoListAdapter;
import com.absjbd.pciu_notice_board.Model.ToDoData;
import com.absjbd.pciu_notice_board.R;
import com.absjbd.pciu_notice_board.Sqlite.SqliteHelper;
import com.absjbd.pciu_notice_board.utils.AlarmRecever;

import java.util.ArrayList;
import java.util.Calendar;

public class ToDoActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
...
//        getWindow().addFlags(WindowManager.LayoutParams.FLAG_KEEP_SCREEN_ON);
    ...
    public void scheduleNotification(long time, String TaskTitle, String TaskPrority) {
        ...
        Intent myIntent = new Intent(ToDoActivity.this, AlarmRecever.class);
        myIntent.putExtra("TaskTitle", TaskTitle);
        myIntent.putExtra("TaskPrority", TaskPrority);
        myIntent.putExtra("id", _id);
        PendingIntent pendingIntent = PendingIntent.getBroadcast(ToDoActivity.this,
